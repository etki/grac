 ...
 * @since 0.1.0
 */
public class RetryPolicyTimeRange {
    ...
    public RetryPolicyTimeRange(long minimumDelay, long maximumDelay, double randomFactor) {
        this.minimumDelay = minimumDelay;
        this.maximumDelay = maximumDelay;
        this.randomFactor = randomFactor;
    }

    public RetryPolicyTimeRange(long minimumDelay, long maximumDelay) {
